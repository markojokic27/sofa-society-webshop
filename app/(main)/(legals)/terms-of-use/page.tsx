export default function Page() {
  return (
    <div className="article mb-48 mt-26 md:mt-44">
      <h1>Terms of Use for Sofa Society</h1>
      <p>
        ...
        platform, you agree to be bound by these terms and conditions. If you do
      ...
      <ol>
        <li>
          Eligibility: You must be at least 16 years old to use our website. If
          you are under the age of 18, you should review these terms with a
      ...
      <p>
        To the maximum extent permitted by law, Sofa Society and its affiliates,
      ...
      <p>
        ...
        the laws. Any disputes arising out of or in connection with these terms
